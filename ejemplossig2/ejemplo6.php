...
<html>
	<head>
		<title>Ejemplo 6 - Ejemplo con visor MSCROSS - CONSULTA A PARTIR DEL CLICK</title>
...
<b>Click sobre un lote dentro del mapa, despues de seleccionar la opción (i) - boton verde   </b>
		...
		<script type="text/javascript">
			...
			{ 
				...
				{ 
					...
					consulta1.open("GET", "consulta_de_ejemplo6.php?x="+xx+"&y="+yy,true);
